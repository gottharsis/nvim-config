...
map( '<C-h>',         function() require('smart-splits').move_cursor_left() end )
map( '<C-j>',         function() require('smart-splits').move_cursor_down() end )
map( '<C-k>',         function() require('smart-splits').move_cursor_up() end )
map( '<C-l>',         function() require('smart-splits').move_cursor_right() end )
